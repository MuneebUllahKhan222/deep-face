        ...
        <Box pt={3} sx={{ height: 'fit-content', backgroundColor: 'transparent', display: 'flex', justifyContent: 'space-between', width:'100%','@media(max-width:700px)': { flexWrap: 'wrap', justifyContent:'center', rowGap:'40px', columnGap:'20px' } }}>
            ...
            <Box mr={1} sx={{ display: 'flex', flexDirection: 'column', width:'180px', '@media(max-width:700px)': { marginBottom: '20px' },  '@media(max-width:570px)': { marginLeft:'25px'  }  }}>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                    ...
                    <Typography onClick={() => handleNavigationWhileProcessing('/refund')} fontSize={14} sx={colorScheme === 'light' ?{ color: '#1F1F1F',fontFamily:'Raleway','&:hover':{cursor:'pointer', textDecoration:'underline'} }:{ color: '#DDDDDD',fontFamily:'Raleway','&:hover':{cursor:'pointer', textDecoration:'underline'} }}>Refund Policy</Typography>
                </Box>
            </Box>
            ...
            <Box sx={{width:'100%', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'space-between', rowGap:'70px'}}>
                ...
                <Typography onClick={() => handleNavigationWhileProcessing('/refund')} fontSize={15} letterSpacing={1.3} sx={colorScheme === 'light' ?{ color: '#1F1F1F',fontFamily:'Raleway','&:hover':{cursor:'pointer', textDecoration:'underline'} }:{ color: '#DDDDDD',fontFamily:'Raleway', '&:hover':{cursor:'pointer', textDecoration:'underline'}}}>Refund Policy</Typography>
                </Box>
            </Box>
            }
            {/* </Box> */}
