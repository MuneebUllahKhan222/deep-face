            ...
            <Box sx={{ height: '350px', display: 'flex', justifyContent: 'center', alignItems: 'center', width: '90%', '@media(max-width:600px)': { height: '300px', width: '100%' } }}>
                <Box mt={7} pl={{ sm: 10, xs: 5 }} pr={{ sm: 10, xs: 5 }} sx={{ height: '45%', backgroundColor: '#1F1F1F', borderRadius: '800px', width: '70%', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <Box sx={{ width: '30%', display: 'flex', justifyContent: 'space-around', alignItems: 'center', '@media(max-width:500px)': { width:'39%' }, }}>
                        ...
                        <Button onClick={() => navigate('/imageSwap/upload')} variant='contained' disableElevation sx={{fontWeight:600, backgroundColor: '#FFD600', height: '45px', borderRadius: '12px', width: '150px', '@media(max-width:450px)': { width:'200px' }, '&:hover': { backgroundColor: '#FFD600' }, }}>Swap It</Button>
                    </Box>
                </Box>
            </Box>
