...
const FooterTerms = () => {
    return (
        ...
        //             <Button variant='contained' disableElevation sx={{backgroundColor:'#FFD600', height:'45px',borderRadius:'12px',width:'150px',  '&:hover':{backgroundColor:'#FFD600'}}}>Swap It</Button>           
        //             </Box>
        //         </Box>
        //     </Box>
